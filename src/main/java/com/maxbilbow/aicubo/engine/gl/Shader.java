...
public class Shader
{
  ...
  private Logger mLogger = LoggerFactory.getLogger(Shader.class);
  ...
  private int bindAndCreateProgram()
  {
    ...
    if (ARBShaderObjects
                .glGetObjectParameteriARB(program, ARBShaderObjects.GL_OBJECT_VALIDATE_STATUS_ARB) == GL11.GL_FALSE)
    {
      System.err.println(getLogInfo(program));
      return 0;
    }
  ...
  private int createShader(String filename, int shaderType) throws Exception
  {
    ...
    try
    {
      ...
      if (ARBShaderObjects
                  .glGetObjectParameteriARB(shader,
