...
import com.maxbilbow.aicubo.messages.NotificationCenter;
...
import static com.maxbilbow.aicubo.config.RMX.rmxDecrimentObjectCount;
import static com.maxbilbow.aicubo.config.RMX.rmxIncrementObjectCount;

public abstract class RMXObject implements IRMXObject
{
  ...
  private Logger mLogger = LoggerFactory.getLogger(RMXObject.class);
  ...
  /* (non-Javadoc)
   * @see click.rmx.IRMXObject#AddObserver(KeyValueObserver, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see click.rmx.IRMXObject#removeObserver(KeyValueObserver, java.lang.String)
   */
  @Override
  ...
  /* (non-Javadoc)
   * @see click.rmx.IRMXObject#removeObserver(KeyValueObserver)
   */
  @Override
...
//				mLogger.debug(this.getClass().getSimpleName() + "::" + key + " OVERRIDES SUPER");
          break;
        default:
          classType.getMethod(methodName, args);
//				mLogger.debug(this.getClass().getSimpleName() + "::" + key + " EXISTS IN HIRACHY");
          break;
      }
      _imps.put(key, true);
      return true;
    ...
    {
      //			mLogger.debug(this.getClass().getSimpleName() + "::" + key + " NOT Implemented");
      _imps.put(key, false);
    }
    return false;
  }
  ...
  public void onEventDidStart(String theEvent, Object args)
  {
    ...
    mLogger.debug(this.uniqueName() + " => Event Started: " + theEvent + " (" + NotificationCenter.getInstance()
            .statusOf(theEvent) + "), with args: " + arg);
  }
  ...
  {
    String arg = args != null ? args.toString() : "N/A";
    mLogger.debug(this.uniqueName() + " => Event Ended: " + theEvent + " (" + NotificationCenter.getInstance()
            .statusOf(theEvent) + "), with args: " + arg);
  }
  ...
  {
    mLogger.debug(this.uniqueName() + " >> " + sender
            .uniqueName() + " will change: " + key + ", from old value: " + value);
  }
  ...
  {
    mLogger.debug(this.uniqueName() + " >> " + sender
            .uniqueName() + " did change: " + key + ", to new value: " + value);
  }
...
//  }
  ...
  public void broadcastMessage(String message)
  {
    ...
    {
      mLogger.warn("Error broadcasting message: " + message, e);
    }
  ...
  public void broadcastMessage(String message, Object args)
  {
    try
    {
      this.sendMessage(message, args);
            ...
            | InvocationTargetException e)
    {
      mLogger.warn("Error broadcasting message: " + message + "(" + args + ")", e);
      e.printStackTrace();
    }
  }
